...
class encn_Cambridge_tc {
    ...
    async findCambridge(word) {
        ...
        for (const entry of entries) {
            ...
            audios[1] = audios[1] ? 'https://dictionary.cambridge.org/zht/' + audios[1].getAttribute('src') : '';
                    ...
                    for (const defblock of defblocks) {
                        ...
                        if (examps.length > 0 && this.maxexample > 0) {
                            ...
                            for (const [index, examp] of examps.entries()) {
                                if (index > this.maxexample - 0) break; // to control only 2 example sentence.
    ...
    renderCSS() {
        let css = `
            <style>
                ...
                ul.sents {font-size:0.8em; list-style:square inside; margin:3px 0;padding:5px;}
